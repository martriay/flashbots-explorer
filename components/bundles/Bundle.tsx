        ...
        <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-200">
              <tr>
                <th scope="col"
                  className='table-heading text-center px-3'>Hash</th>
                <th scope="col"
                  className='table-heading text-center px-3'>From</th>
                <th scope="col"
                  className='table-heading text-center px-3'>To</th>
                <th scope="col"
                  className='table-heading text-center px-3'>Assets</th>
                <th scope="col"
                  className='table-heading text-center px-3'>Gas used</th>
                <th scope="col"
                  className='table-heading text-center px-3'>Gas price</th>
                <th scope="col"
                  className='table-heading text-center px-3'>Coinbase transfer</th>
                <th scope="col"
                  className='table-heading text-center px-3'>Miner reward</th>
              </tr>
            </thead>
            <tbody className="bg-white divide-y divide-gray-200">
              {
                bundle.transactions.length > 1
                  ? bundle.transactions.map((sb, i) => <SubBundle key={ i }
                    index={ i }
                    subBundle={ sb } />)
